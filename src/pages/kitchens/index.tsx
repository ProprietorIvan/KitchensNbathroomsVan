...
const KitchenLandingPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("/api/kitchen_email", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const serviceFeatures = [
    {
      ...
      description: "High-end countertops and custom cabinetry",
    },
    {
      icon: <Layout className="w-6 h-6" />,
      title: "Custom Design",
      description: "Personalized layouts for optimal functionality",
    },
    {
  ...
  const kitchenStyles = [
    {
      ...
      description:
        "Clean lines, integrated appliances, and sleek finishes for a contemporary look.",
      image: "/photos/kitchens/hero.jpg",
    },
    {
      title: "Classic Elegance",
      description:
        "Timeless designs with premium materials and thoughtful details.",
      image: "/photos/kitchens/Renovation-cuisine-Paris-14-Particuliers.jpg",
    },
    {
      title: "Open Concept",
      description:
        "Seamless integration with living spaces for entertaining and family gatherings.",
      image: "/photos/kitchens/IMG_5944.webp",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl font-light text-white/90 mb-10 tracking-wide">
              Elevate your culinary space with premium kitchen renovations in
              Vancouver
            </p>
            <button
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-600">
              We create exceptional kitchen spaces with minimalist design
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-light mb-6">Kitchen Design Styles</h2>
            <p className="text-gray-600">
              Explore our range of kitchen design styles, each crafted with
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-600">
              ...
              quote for your kitchen renovation.
            </p>
          </div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full p-3 bg-white border border-gray-300 focus:border-black focus:ring-0 transition-all"
                    placeholder="Tell us more about your kitchen renovation project..."
                  ></textarea>
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-600">
              We follow a proven process to ensure your kitchen renovation
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Design",
                description:
                  "Our designers create a custom concept tailored to your cooking style and preferences.",
              },
              {
                number: "03",
                title: "Construction",
  ...
  return (
    <div className="bg-gray-50 p-8 md:p-12 text-center">
      ...
      <p className="text-gray-600 mb-6">
        Your kitchen renovation inquiry has been received. We&apos;ll send a
...
export default KitchenLandingPage;
